...
export const missionData = [
    ...
    },
    {
        ...
        Icon: Icons.misssionTwo,
        title: "Инновационность",
        desc: "Мы постоянно ищем новые и инновационные подходы, идеологии и технологии, которые могут быть применены в нашей работе. Мы постоянно улучшаем наш конечный продукт, чтобысоответствовать самым высоким стандартам качества.",
    },
    {
        id: 3,
        image: "/mission/03.png",
        Icon: Icons.misssionThree,
        title: "Надежность",
        desc: "Наша компания на протяжении 12 лет является надежным партнером, надежным производителем и надежным работодателем. Мы считаем, что надежность - это фундаментальное качество, которое должно присутствовать во всех наших продуктах, услугах и взаимоотношениях с клиентами и партнерами.",
    },
];
